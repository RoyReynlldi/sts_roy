<?php
    ...
    if(isset($_POST['tambah'])) {
        tambahBarang($_POST['kode_barang'], $_POST['nama_barang'], $_POST['kategori'], $_POST['merk'], $_POST['jumlah']);
    ...
    <div id="wrapper">
        ...
        <h1 class="h3 mb-4 text-gray-800">Tambah Data Barang</h1>
            <form class="user" method="POST">
                ...
                <div class="form-group">
                    <input type="text" class="form-control form-control-user" placeholder="Merek" name="merk">
                </div>
                <div class="form-group">
